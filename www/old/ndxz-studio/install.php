...
*/
	...
	if ((file_exists(DIRNAME . BASENAME . '/config/config.php')) && ($page != 3))
	{
		echo 'You need to delete the /ndxz-studio/config/config.php file if you wish to install Indexhibit.';
		exit;
	}
...
?>";
		if (!file_exists(DIRNAME . BASENAME . '/config/config.php'))
		{
			if (is_writable($path)) 
			{
...
<?php
	...
	elseif ($page == 3)
	{
		if ($_GET['s'] == 'success')
		{
			...
			echo "<br /><p><strong style='color: red;'>Delete the install.php file from your site.</strong></p><br />";
